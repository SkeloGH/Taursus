tickers = [
    ...
    "AESI", # Atlas Energy Solutions Inc. Class A Common Stock
    ...
    "AMSF", # AMERISAFE INC
    # "AMSW.A", # American Software Inc-GA
    ...
    "ROVR", # Rover Metals Corp
    "RPAY", # Repay Holdings Corp
    "RPD", # Rapid7, Inc.
    # "RPHM", # OnKure Therapeutics, Inc.
    ...
    "SG", # Sweetgreen, Inc.
    "SGH", # SWEDISH EXPORT CREDIT CORP /SWED/
